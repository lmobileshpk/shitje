...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Produktet
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="active">Produktet</li>
			</ul>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			<div style="text-align:center;">
			<font style="color:rgb(255, 95, 66);; font:bold 22px 'Aleo';">[<?php echo $rowcount123;?>]</font> Produktet jane me pak se 10 njesi
			</div>
</div>
<?php 
			include('../connect.php');
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Jeni i sigurt që dëshironi ta fshini këtë produkt?!"))
		  {
